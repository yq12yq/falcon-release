  ...
  module.factory('ValidationService', ["$window", function ($window) {
    var checkMessages = {
      ...
      checkPatterns = {
        ...
        password: new RegExp("^(.*){1,39}$"),
        passwordFile: new RegExp("^[\\/]{0,1}([^\\/]+[\\/])*([^\\/]*)$"),
        passwordAlias: new RegExp("^(([a-zA-Z\\/]([\\-a-zA-Z0-9\\/])*){1,39})$"),
        ...
        kerberosPrincipal : new RegExp("^hive\\/+[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-_]+\\.[a-zA-Z]{2,4}$"),
