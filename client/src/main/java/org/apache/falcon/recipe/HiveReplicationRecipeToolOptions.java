...
public enum HiveReplicationRecipeToolOptions {
    ...
    REPLICATION_SOURCE_HS2_EXTRA_OPTS("sourceHiveServer2ExtraOpts", "Source HS2 extra opts", false),
    ...
    REPLICATION_TARGET_HS2_URI_EXTRA_OPTS("targetHiveServer2ExtraOpts", "Target HS2 extra opts", false),
