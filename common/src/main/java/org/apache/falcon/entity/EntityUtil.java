...
public final class EntityUtil {
    ...
    public static Date getNextInstanceTimeWithDelay(final Date instanceTime, final Frequency delay, TimeZone tz) {
        if (tz == null) {
            tz = TimeZone.getTimeZone("UTC");
        }
        final Calendar insCal = Calendar.getInstance(tz);
        insCal.setTime(instanceTime);
